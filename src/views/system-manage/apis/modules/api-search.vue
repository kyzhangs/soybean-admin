...
import { fetchGetApiTags } from '@/service/api';
...
const tagOptions = ref<CommonType.Option<string, string>[]>([]);
              ...
              <NGrid responsive="screen" item-responsive>
                ...
                >
                  <NSelect
                    ...
                    :placeholder="$t('page.system-manage.apis.form.method')"
                ...
                >
                  <NCascader
                    ...
                    :options="tagOptions"
                    :placeholder="$t('page.system-manage.apis.form.tags')"
                    filterable
                    clearable
                    @update:value="search"
                    @clear="search"
                ...
                >
                  <NSelect
                    ...
                    :placeholder="$t('page.system-manage.apis.form.status')"
